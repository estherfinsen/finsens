...
const Footer = () => {
  return (
    <div className="items-center pt-5 pb-10 px-10 bg-box_purple text-blue uppercase">
      <Link href="/" className="self-start">
        <p className={`${work_header.className} uppercase text-box_red text-footer`}>Finsens</p>
      </Link>
